...
public class UnitTest {
    ...
    public void mobileContact() throws Exception {
        ...
        config.setProperty("deviceName", "Oneplus 3T"); // Defining the name of the mobile device
        String unique = config.getProperty("address") + config.getProperty("deviceName");
        String deviceHash1 = MobileDevice.HashGenerator(unique); // Send the combined string as parameter to generate the unique Hash of the device.
        ...
        String deviceHash2 = MobileDevice.HashGenerator(unique); // Send the combined string as parameter to generate the unique Hash of the device.
        config.setProperty("deviceHash",deviceHash2);
        MobileDevice mobile2 = new MobileDevice(config2,gov);

        mobile.recordContact(deviceHash2,3,3);
        mobile2.recordContact(deviceHash1,3,4);

        Assertions.assertFalse(mobile.synchronizeData());
    }

    @Test
    @DisplayName("Testing More Contacts")
    public void AnotherContact() throws Exception {
        Properties govtproperties = new Properties(); // We create a properties object to define the properties of the Government.
        govtproperties.setProperty("user","harjot"); // Used to store the username
        govtproperties.setProperty("password","B00872298"); // Used to store the password
        govtproperties.setProperty("url","jdbc:mysql://db.cs.dal.ca:3306/harjot"); //// Used to store the Database URL
        ...
        String deviceHash3 = MobileDevice.HashGenerator(unique); // Send the combined string as parameter to generate the unique Hash of the device.
        ...
        String deviceHash4 = MobileDevice.HashGenerator(unique); // Send the combined string as parameter to generate the unique Hash of the device.
        ...
        String deviceHash5 = MobileDevice.HashGenerator(unique);// Send the combined string as parameter to generate the unique Hash of the device.
        ...
        String deviceHash6 = MobileDevice.HashGenerator(unique);// Send the combined string as parameter to generate the unique Hash of the device.
        ...
        String deviceHash7 = MobileDevice.HashGenerator(unique); // Send the combined string as parameter to generate the unique Hash of the device.
        ...
        String deviceHash8 = MobileDevice.HashGenerator(unique); // Send the combined string as parameter to generate the unique Hash of the device.
        ...
        String deviceHash9 = MobileDevice.HashGenerator(unique); // Send the combined string as parameter to generate the unique Hash of the device.
        ...
        String deviceHash10 = MobileDevice.HashGenerator(unique); // Send the combined string as parameter to generate the unique Hash of the device.
        ...
        Assertions.assertFalse(device1.synchronizeData());
        Assertions.assertFalse(device2.synchronizeData());
        Assertions.assertFalse(device3.synchronizeData());
